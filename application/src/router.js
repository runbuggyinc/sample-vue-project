...
// Layouts
import DriversLayout from '@/layouts/_boilerplate';

// Views
import DriversIndex from '@/views/_boilerplate';
import DriversProfile from '@/views/_boilerplate/views';
